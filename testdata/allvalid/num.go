...
// mathematical operations (see https://golang.org/pkg/math/).
type Set []float64
...
// Pi is the same as math.Pi: https://golang.org/pkg/math/#pkg-constants
const Pi = math.Pi

// Min returns the minimum number in the set
// using math.Min: https://golang.org/pkg/math/#Min.
...
// using math.Max: https://golang.org/pkg/math/#Max.
